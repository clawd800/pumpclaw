...
contract PumpClawV4Test is Test {
    ...
    function test_CreateTokenWithDefaultFDV() public {
        ...
        PumpClawFactoryV4.TokenInfo memory info = factory.getTokenInfo(token);
    ...
    function test_RegistryPagination() public {
        ...
        // Page 1
        PumpClawFactoryV4.TokenInfo[] memory page1 = factory.getTokens(0, 2);
        assertEq(page1.length, 2);
        assertEq(page1[0].initialFdv, 10 ether);
        assertEq(page1[1].initialFdv, 20 ether);

        // Page 2
        PumpClawFactoryV4.TokenInfo[] memory page2 = factory.getTokens(2, 4);
        assertEq(page2.length, 2);
        assertEq(page2[0].initialFdv, 30 ether);

        // Last page (partial)
        PumpClawFactoryV4.TokenInfo[] memory page3 = factory.getTokens(4, 10);
