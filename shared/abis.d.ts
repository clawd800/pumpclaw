...
export declare const SWAP_ROUTER_ABI: readonly [
  {
    ...
    readonly inputs: readonly [
      ...
      { readonly name: "minTokensOut"; readonly type: "uint256" },
    ];
    readonly outputs: readonly [{ readonly name: "tokensOut"; readonly type: "uint256" }];
  ...
  },
  {
    ...
    readonly inputs: readonly [
      { readonly name: "token"; readonly type: "address" },
      { readonly name: "tokensIn"; readonly type: "uint256" },
      { readonly name: "minEthOut"; readonly type: "uint256" },
    ];
    readonly outputs: readonly [{ readonly name: "ethOut"; readonly type: "uint256" }];
    readonly stateMutability: "nonpayable";
  },
];
