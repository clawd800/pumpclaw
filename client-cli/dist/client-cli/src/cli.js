...
import { CONTRACTS, BASE_RPC, FACTORY_ABI, LOCKER_ABI, TOKEN_ABI, SWAP_ROUTER_ABI, FEE_VIEWER_ABI, DEFAULT_FDV, DEFAULT_SUPPLY, } from "./constants.js";
...
program
    ...
    try {
        ...
        const hash = await walletClient.writeContract({
            ...
            args: [tokenAddress, 0n], // 0 for no slippage protection
            value: ethAmount,
        });
        console.log(`Transaction: ${hash}`);
        console.log("Waiting for confirmation...");
